...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.pjc0j.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            // step 02: get the booking of the date
            const query = { date: date };
            const bookings = await bookingCollection.find(query).toArray();
            // step 03: for each service, find booking fot that service
